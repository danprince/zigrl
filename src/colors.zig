...
pub const red = rgb(0xFF, 0x0, 0x0);

pub const player_atk = rgb(0xE0, 0xE0, 0xE0);
pub const enemy_atk = rgb(0xFF, 0xC0, 0xC0);
pub const needs_target = rgb(0x3F, 0xFF, 0xFF);
pub const status_effect_applied = rgb(0x3F, 0xFF, 0x3F);
pub const descend = rgb(0x9F, 0x3F, 0xFF);

pub const player_die = rgb(0xFF, 0x30, 0x30);
pub const enemy_die = rgb(0xFF, 0xA0, 0x30);
pub const invalid = rgb(0xFF, 0xFF, 0x00);
pub const impossible = rgb(0x80, 0x80, 0x80);
pub const errors = rgb(0xFF, 0x40, 0x40);

pub const welcome_text = rgb(0x20, 0xA0, 0xFF);
pub const health_recovered = rgb(0x0, 0xFF, 0x0);
